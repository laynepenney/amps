...
public final class Todo implements Model {
  ...
  private final @ModelField(targetType="Boolean", isRequired = true) Boolean isDone;
  ...
  public static IsDoneStep builder() {
      return new Builder();
  }
  ...
  public static class Builder implements IsDoneStep, BuildStep {
    private String id;
